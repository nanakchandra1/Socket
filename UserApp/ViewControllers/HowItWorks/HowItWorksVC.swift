...
class HowItWorksVC: UIViewController {
    ...
    func initialSetup() {
        ...
        self.tutorialScrollView.contentSize = CGSize(width: screenWidth*3, height: 1)
        
        let firstTutorialVC = getStoryboard(StoryboardName.User).instantiateViewController(withIdentifier: "FirstHowItWorksVC") as! FirstHowItWorksVC
        
        let secondTutorialVC = getStoryboard(StoryboardName.User).instantiateViewController(withIdentifier: "SecondHowItWorksVC") as! SecondHowItWorksVC
        
        let thirdTutorialVC = getStoryboard(StoryboardName.User).instantiateViewController(withIdentifier: "ThirdHowItWorksVC") as! ThirdHowItWorksVC
    ...
    func setDotViewColor(_ view: UIView) {
        ...
        view.backgroundColor = .redButton
    }
...
extension HowItWorksVC: UIScrollViewDelegate {
